...
![image-20211213173300668](Picture/MementoMode.png)
...
利用备忘录模式设计相亲游戏。
 ...
 客户类设计成窗体程序，它包含美女栈（GirlStack）对象和相亲者（You）对象，它实现了 ActionListener 接口的事件处理方法  actionPerformed(ActionEvent e)，并将 4 大美女图像和相亲者（You）选择的美女图像在窗体中显示出来。下图所示是其结构图。

![image-20211213173528903](Picture/MementoMode-Girl.png)
